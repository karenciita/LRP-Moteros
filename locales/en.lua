Locales['en'] = {
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Interacion Civil',
  ['vehicle_interaction'] = 'Interacion Vehicular',
  ['object_spawner'] =      'Colocar Objetos',
  ['animations'] = 'animations',

  ['id_card'] = 'Revisar Billetera',
  ['search'] =  'Revisar Bolsillos',
  ['handcuff'] = 'cuff / Uncuff',
  ['drag'] = 'drag',
  ['put_in_vehicle'] = 'Poner en el Vehiculo',
  ['out_the_vehicle'] = 'Sacar del Vehiculo',
  ['fine'] = 'Extorsion/Cupos',
  ['no_players_nearby'] = 'no players nearby',

  ['vehicle_info'] = 'Informacion del Vehiculo',
  ['pick_lock'] = 'Abrir Cerradura del Vehiculo',
  ['vehicle_unlocked'] = 'vehicle ~g~Unlocked~s~',
  ['no_vehicles_nearby'] = 'no vehicles nearby',

  ['traffic_interaction'] = 'Spawn de Objetos',
  ['cone'] = 'Cono',
  ['barrier'] = 'Barrera',

  ['paquetedrogacoca'] = 'Paquete de Cocaina',
  ['paquetedrogamari'] = 'Paquete de Marihuana',
  ['paquetedrogameta'] =     'Paquete de Metanfetamina',
  ['box'] = 'box',
  ['cash'] = 'Fajos de Dinero',
